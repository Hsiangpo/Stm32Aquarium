...
export const IOTDA_SERVICE_ID_AQUARIUM = 'Aquarium';
export const IOTDA_SERVICE_ID_CONTROL = 'aquarium_control';
export const IOTDA_SERVICE_ID_THRESHOLD = 'aquarium_threshold';
export const IOTDA_SERVICE_ID_CONFIG = 'aquariumConfig';
