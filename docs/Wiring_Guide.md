...
| [x] | 舵机（SG90 或金属齿轮） | 已买 x1 | 带安装支架 | 驱动投饵装置 |
...
| [x] | 管箍/卡箍（8–12 mm） | 已买 x6 | 不锈钢 | 固定水管防漏 |
...
| [x] | 传感器固定吸盘/夹具套件 | 已买 x1 | 通用硅胶吸盘或夹具 | 10 个装，固定温度/pH/TDS/浊度/水位探头 |
| [x] | 投饵装置套件（适配 SG90） | 已买 x1 套 | 含舵机支架 + 饲料盒 + 连杆 | 已买：舵机支架 x1 + 连杆 x1 + 饲料盒 x1 |
| [x] | 防水接线盒 | 已买 x1 | IP65 左右 | 保护板卡与继电器 |
...
5. **舵机与投饵装置**：舵机信号线接 D9，电源线连接 5 V 与 GND。安装投饵机构时确保舵机可自由旋转 0–180°，无卡滞现象。
