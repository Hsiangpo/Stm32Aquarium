...
- ESP32 AT 使用 `USART1 (PA9/PA10)`，避免了 `USART2 (PA2/PA3)` 与 ST-LINK VCP 冲突。
...
1. 配置 SNTP：`AT+CIPSNTPCFG=1,0,"ntp.aliyun.com","ntp.ntsc.ac.cn","time.cloudflare.com"`
...
- AP SSID: `Aquarium_Setup`，密码固定 `12345678`（显示在 OLED/串口）
